...
echo "🚀 DÉPLOIEMENT VERCEL HYBRIDE - ORACLE PORTFOLIO"
echo "================================================"

# Variables
PROJECT_NAME="oracle-portfolio-v2-6-1-hybride-secteurs"
BRANCH_NAME="backup-20250816-1930"
...
# 6. Déploiement Firebase Functions
echo "🔥 Déploiement Firebase Functions..."
cd functions
firebase deploy --only functions:getIndicatorsBreakdown,functions:getRegime
if [ $? -ne 0 ]; then
    echo "❌ Échec du déploiement Firebase Functions"
    exit 1
fi
cd ..
...
git add .
git commit -m "deploy: version hybride validée - $(date '+%Y-%m-%d %H:%M:%S')"
...
echo "🔥 Firebase Functions: Déployées"
echo "🌐 Vercel: Déployé"
echo ""
echo "⏳ Surveillez le déploiement sur: https://vercel.com/alain-poncelas-projects/$PROJECT_NAME/deployments"
echo ""
echo "🔑 Test des APIs:"
echo "   Firebase: https://us-central1-oracle-portfolio-prod.cloudfunctions.net/getRegime"
